...
<div class="container-fluid  py-4">
    ...
    <div class="d-flex justify-content-between">
        ...
        <form action="export_to_excel.php" method="GET">
            <button type="submit"  class="btn btn-secondary rounded-0  " name="getsubmit"  ><span class="d-sm-none d-block  "><i class="fa-solid fa-file-excel"></i></span><span class="d-none d-sm-block ms-1"> Download Excel</span> </button>
    ...
    <div class="d-flex justify-content-between align-items-center mt-3 rounded-1 text-bg-light  p-3">
        <p class="m-0   "><span class="fw-bold display-6">
            ...
            <br><span class="fw-bold">ATTENDEES:</span> <?php echo $count_display?> (Archived attendees not included)</p>
    ...
    <div class="row">
        ...
        <table class=" table table-secondary shadow-sm mt-2">
            <tr >
                <th>#</th>
                <th>NAME</th>
                <th>TIME IN</th>
            ...
            <input type="submit" name="archive" class="btn btn-danger" value="Archive" >  
            </form>
            ...
            <input type="hidden" name="event_id"  value="<?php echo htmlspecialchars($Attendees['event_id']);?>">
            <input type="submit" name="unarchive"  class="btn btn-success" value="Unarchive" >  
            </form>
