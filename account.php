 ...
 <div class="card border-0 rounded-0 p-0 m-0" style="max-width:20em;" >
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-12">
      ...
      <input type="password" class="form-control w-100 bg-body-secondary " name="old_password">

      <?php if (isset($errors['old_password'])):?>
        <div class="alert alert-danger p-0 m-0 rounded-0 w-100  " role="alert">
          <i class="fa-solid fa-circle-exclamation me-1"></i><?php echo htmlspecialchars($errors['old_password'] ?? ''); ?></div> 
      <?php endif;?>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-12">
      ...
      <input type="password" class="form-control w-100 bg-body-secondary " name="new_password">
  
        
    <?php if (isset($errors['new_password'])):?>
      <div class="alert alert-danger p-0 m-0 rounded-0 w-100" role="alert">
        <i class="fa-solid fa-circle-exclamation me-1"></i><?php echo htmlspecialchars($errors['new_password'] ?? ''); ?></div> 
        <?php endif;?>
    </div>
  </div>
  <div class="mb-3 row">
    ...
    <div class="col-sm-12">
      <input type="password" class="form-control w-100 bg-body-secondary " name="confirm_password">
    </div>
  </div>
    </div>
