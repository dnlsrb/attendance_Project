...
<div id="message" class="alert alert-light w-100 shadow-sm mt-2 rounded-0 fw-bold position-sticky top-0 z-3  " role="alert">
    WELCOME TO <?php echo htmlspecialchars($eventLists['eventName']);?>
</div>
        ...
        function sendData($form){
            ...
            return $.ajax({
                ...
                success: function(data){
                    $("#message").empty();
                    $("#message").html(data.name_message.message);
                    console.log(data.name_message.message);
                },
            });
