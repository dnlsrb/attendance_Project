...
<div class="position-relative">
    ...
    <?php $header = 'background-image:url( image/header/' . htmlspecialchars($eventLists['eventHeaderImage']) . ' ) ;      background-repeat: no-repeat;
        background-size: cover;' ?>
        ...
        <div class="row">
            ...
            <div class="col">
                <?php if ($eventLists) : ?>
                    ...
                    <iframe src="iframe_attendance.php?id=<?php echo htmlspecialchars($id); ?>" class="iframe-class" sallowtransparency="true" scrolling="yes" width="100%" height="100%" frameborder="5"></iframe>
